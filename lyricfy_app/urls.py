...
urlpatterns = [
    ...
    # url(r'^Playlists/(?P<playlist_name>[\w-]+)/(?P<username>[\w-]+)/Edit_Playlist/$', views.Edit_Playlist, name="Edit_playlist"),
    ...
    url(r'^Playlists/Delete_Playlist/$', views.Delete_Playlist, name="Delete_playlist"),
